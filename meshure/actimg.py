...
class ActImg:
    ...
    def threshold_manual(self, threshold: float):
        """ Returns a binary thresholded image.
        Values < threshold will be labelled as object (1), while the rest discarded as background (0).
        Note: can be called after normalisation.
        ...
